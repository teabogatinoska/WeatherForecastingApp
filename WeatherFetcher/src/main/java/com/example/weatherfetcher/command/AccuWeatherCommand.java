    ...
    public void fetchWeatherData(UserDataRequestDto requestDto, KafkaTemplate<String, String> kafkaTemplate) {
        ...
        try {
            if (locationId != null) {
                ...
                messageNode.put("username", requestDto.getUsername());
                messageNode.put("location", requestDto.getLocation().getName());
                messageNode.put("country", requestDto.getLocation().getCountry());
                messageNode.set("weatherData", weatherDataNode);
